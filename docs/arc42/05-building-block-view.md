...
| Review card renderer | Render the framed, colorized card (header, command, stage position, selected stage and purpose, focus tabs, actions, key hints) behind the presentation-adapter seam; the portable plain panel remains the fallback |
