...
| Review card renderer | Render the framed card (header, command, stage position, selected stage and purpose, focus tabs, actions, key hints) as the only review surface; color is a property of the terminal, not an adapter choice |
