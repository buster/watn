...
# - start `watn setup` in a terminal and confirm or cancel provider setup
# - run `watn models` with tier assignments

@givn.delta @setup-persistence
Feature: Setup persistence boundaries
