...
- [x] COMMIT: test(providers): fill `request_sent_to_url` assertion
...
- [x] COMMIT: test(providers): fill `should_query_models_at` assertion
...
- [x] COMMIT: test(providers): fill `request_has_auth_header` assertion
...
- [x] COMMIT: test(providers): fill `request_sent_to_provider` assertion
