...
# - run `watn setup` and complete the provider and model wizard
# - run `watn models` with provider information configured and enter model selection
# - leave the setup wizard with Escape and choose whether to discard current settings
