...
use super::watn_consolidation_support::{
    duplicate_titles, feature_text, fixture_specs, fixture_stdout, invoke_givn, setup_fixture,
};
use crate::WatnWorld;
...
fn run_fixture_review(world: &mut WatnWorld) {
    invoke_givn(
        world,
        &["check", "review", "--change", "fixture-consolidation"],
    );
}
