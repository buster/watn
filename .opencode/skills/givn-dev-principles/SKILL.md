...
description: Apply the team's engineering principles whenever code is read or written during a givn change — correctness first, boring when called for, no unnecessary abstractions.
---
